 ...
 * Supported types: inbound, message-processor, data-source
 ...
 */
public class ICPGetInboundEndpointParamsResource extends APIResource {

    private static final Log LOG = LogFactory.getLog(ICPGetInboundEndpointParamsResource.class);

    public ICPGetInboundEndpointParamsResource(String urlTemplate) {
        super(urlTemplate);
    }
